...
init:
	...
	./bin-docker/php ./bin/console lexik:jwt:generate-keypair --skip-if-exists --quiet
...
init-tests:
	...
	./bin-docker/php ./bin/console --env=test lexik:jwt:generate-keypair --skip-if-exists --quiet
